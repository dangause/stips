...
| Detector | Single 2048x2048 Loral CCD (1 detector, ID 0) |
| Plate scale | 0.37 arcsec/pixel |
| Field of view | ~6.3 arcmin |
| Target | SN 2023ixf in M101 (RA=210.9108, Dec=+54.3117) |
| Template type | Pan-STARRS1 3pi (PS1) |
| Total processed visits | 373 |
| Bands | R (210 visits), I (163 visits) |
| Exposure times | 10--70 s (median 20 s) |
