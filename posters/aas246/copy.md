...
- Slurm logo — source: https://commons.wikimedia.org/wiki/File:Slurm_logo.svg (rasterized from SVG). License: GNU GPL v2 or later (same as the Slurm software). Note: the "Slurm" name is a SchedMD trademark; the logo image itself is GPL-licensed via Wikimedia Commons. Credit: SchedMD / Slurm project.
