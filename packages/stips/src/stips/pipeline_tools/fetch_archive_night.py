...
Usage:
  stips-archive-fetch-night --night YYYYMMDD [--raw-root PATH] [--archive-url URL]
  # or via module invocation
  python -m stips.pipeline_tools.fetch_archive_night --night YYYYMMDD [--raw-root PATH] [--archive-url URL]
