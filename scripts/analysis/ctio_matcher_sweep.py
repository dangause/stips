...
def format_table(results: list[dict]) -> str:
    ...
    # Header labels held in vars: a backslash inside an f-string *expression*
    # (e.g. {'MEAN_SEP\"':>10}) is a SyntaxError before Python 3.12.
    mean_hdr = 'MEAN_SEP"'
    max_hdr = 'MAX_SEP"'
    lines = [f"{'LABEL':<24} {'MATCH_RATE':>10} {mean_hdr:>10} {max_hdr:>9}"]
    for r in ranked:
        lines.append(
...
def main() -> None:
    ...
    base = dict(
        ...
        maxRotationDeg=1.0,
        minMatchedPairs=15,
        minFracMatchedPairs=0.05,
        numBrightStars=300,
        maxRefObjects=10000,
        numPatternConsensus=3,
        magLimitMin=11.0,
        magLimitMax=18.0,
        pixelMargin=400,
        psfThreshold=5.0,
