...
Usage:
  ./scripts/fetch_archive_night.py --night YYYYMMDD [--raw-root PATH] [--archive-url URL]
...
def main() -> int:
    ...
    parser.add_argument(
        "--instrument",
        default=os.environ.get("LICK_ARCHIVE_INSTR", "NICKEL"),
        help="Archive instrument filter value",
    )
    parser.add_argument(
        "--page-size",
        type=int,
